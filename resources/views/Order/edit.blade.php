...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h2 class="text-decoration-underline mb-4 text-muted">Order id { <span id="order_id">{{ $data['order']->id }}</span>} Update Form</h2>
                </div>
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="d-flex col-sm-12 col-md-3 mb-4">
                    ...
                    <input id="transaction_number" type="text" class="form-control @error('transaction_number') is-invalid @enderror" name="transaction_number" value="{{ old('transaction_number',$data['order']->transaction_number) }}" required autocomplete="transaction_number">
                </div>

                <div class="d-flex col-sm-12 col-md-4 mb-4">
                    <label for="item_id" class="col-md-4 col-form-label text-md-end">to</label>
                    <input id="from" type="text" class="form-control @error('from') is-invalid @enderror" name="from" value="{{ old('from',$data['order']->to) }}" required autocomplete="from">
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <button id="send" class="btn btn-success w-25 float-right"onclick="updateorder()">Save</button>
                </div>
            </div>
        </div>
    </section>
